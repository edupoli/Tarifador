<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPlanoTarifacao.aspx.cs" Inherits="WebApplication19.PlanoTarifacao" %>
        ...
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <asp:Button Text="Voltar" CssClass="btn btn-sm btn-secondary" runat="server" ID="btnVoltar"/>
              ...
              <div class="row">
                ...
                <div class="form-group">
                  <label>Operadora</label>
                    <asp:DropDownList runat="server" ID="cboxOperadoras" CssClass="form-control select2" style="width: 100%;" DataSourceID="SqlDataSourceOperadoras" DataTextField="descricao" DataValueField="codigo">
                    </asp:DropDownList>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <label>Taxa de conexão</label>
                        <asp:TextBox runat="server" ID="taxaConexao" CssClass="form-control"  />
                    </div>
                </div>
             </div>
        </div>
