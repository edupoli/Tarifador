<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VisualizarPlano.aspx.cs" Inherits="Tarifador.VisualizarPlano" %>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <label>Tempo Mínimo de Chamada</label>
                        <asp:TextBox runat="server" ID="tempoMinimo" CssClass="form-control" ReadOnly="true"  />
                    </div>
                </div>
               <div class="col-md-4">
                    <div class="form-group">
                      <label>Tempo de Tarifação Mínimo</label>
                        <asp:TextBox runat="server" ID="tempoTarifMinimo" CssClass="form-control" ReadOnly="true" />
                    </div>
                </div>
                <!-- /.form-group -->
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <label>Periodicidade de Tarifa</label>
                        <asp:TextBox runat="server" ID="periodicidade" CssClass="form-control" ReadOnly="true" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                      <label>Taxa de conexão</label>
                        <asp:TextBox runat="server" ID="taxaConexao" CssClass="form-control" ReadOnly="true" />
                    </div>
                </div>
             </div>
        </div>
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                  <div class="tab-pane text-left fade show active" id="vert-tabs-0300" role="tabpanel" aria-labelledby="vert-tabs-0300-tab">
                     <div class="col-md-4">
                        <div class="form-group">
                          <label>Valor</label>
                            <asp:TextBox runat="server" ID="valor0300" CssClass="form-control" data-inputmask='"mask": "9,99"' data-mask ReadOnly="true"/>
                        </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="vert-tabs-DDDCelular" role="tabpanel" aria-labelledby="vert-tabs-DDDCelular-tab" />
                     <div class="col-md-4">
                        <div class="form-group">
                          <label>Valor</label>
                            <asp:TextBox runat="server" ID="valorDDDCelular" CssClass="form-control" data-inputmask='"mask": "9,99"' data-mask ReadOnly="true" />
                        </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="vert-tabs-DDDFixo" role="tabpanel" aria-labelledby="vert-tabs-DDDFixo-tab"  >
                     <div class="col-md-4">
                        <div class="form-group">
                          <label>Valor</label>
                            <asp:TextBox runat="server" ID="valorDDDFixo" CssClass="form-control" data-inputmask='"mask": "9,99"' data-mask ReadOnly="true"/>
                        </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="vert-tabs-LocalCelular" role="tabpanel" aria-labelledby="vert-tabs-LocalCelular-tab">
                     <div class="col-md-4">
                        <div class="form-group">
                          <label>Valor</label>
                            <asp:TextBox runat="server" ID="valorLocalCelular" CssClass="form-control" data-inputmask='"mask": "9,99"' data-mask ReadOnly="true"/>
                        </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="vert-tabs-LocalFixo" role="tabpanel" aria-labelledby="vert-tabs-LocalFixo-tab">
                     <div class="col-md-4">
                        <div class="form-group">
                          <label>Valor</label>
                            <asp:TextBox runat="server" ID="valorLocalFixo" CssClass="form-control" data-inputmask='"mask": "9,99"' data-mask ReadOnly="true" />
                        </div>
                    </div>
                  </div>
                </div>
